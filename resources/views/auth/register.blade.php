...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('backend/assets/images/favicon_rmp_logo.ico') }}">
                        ...
                        <div class="text-center mt-4">
                            <div class="mb-3">
                                <a href="index.html" class="auth-logo">
                                    <img src="{{ asset('backend/assets/images/Logo_of_RMP.png') }}" height="100" class="logo-dark mx-auto" alt="">
                                    <img src="{{ asset('backend/assets/images/Logo_of_RMP.png') }}" height="100" class="logo-light mx-auto" alt="">
                                </a>
                            </div>
                        </div>
    
                        <h4 class="text-muted text-center font-size-18"><b>Rajshahi Metropolitan Police </br>Register</b></h4>
